        ...
        for filename in os.listdir(input_folder):
            if filename.endswith('.tx0'):
                ...
                with open(input_file_path, 'r') as input_file:
                    ...
                    # Find the starting line dynamically
                    start_index = 0
                    for index, line in enumerate(lines):
                        if "* Data *****" in line:  # You can adjust this condition to be more specific
                            start_index = index + 3  # Assuming data starts two lines after this line
                            break
